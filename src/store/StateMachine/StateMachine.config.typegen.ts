...
export interface Typegen0 {
  "@@xstate/typegen": true;
  internalEvents: {
    "done.invoke.embed_message": {
      type: "done.invoke.embed_message";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    "done.invoke.fetch_message": {
      type: "done.invoke.fetch_message";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    "done.invoke.read_file": {
      type: "done.invoke.read_file";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    "done.invoke.save_file": {
      type: "done.invoke.save_file";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    "error.platform.embed_message": {
      type: "error.platform.embed_message";
      data: unknown;
    };
    "error.platform.fetch_message": {
      type: "error.platform.fetch_message";
      data: unknown;
    };
    "error.platform.read_file": {
      type: "error.platform.read_file";
      data: unknown;
    };
    "error.platform.save_file": {
      type: "error.platform.save_file";
      data: unknown;
    };
  ...
  matchesStates:
    ...
    | "config_actions.image_opening.idle"
    | "config_actions.image_opening.reading_image"
    | "config_actions.user_actions"
    | "config_actions.user_actions.form_editing"
    | "embedding_message"
    | "embedding_message.embedding_in_progress"
    | "embedding_message.saving_file_in_progress"
    | "fetching_message"
